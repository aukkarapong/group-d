...
<body>
    ...
    <div class="container-fluid position-relative p-0">
        ...
        <div class="container-fluid">
            <h1>KU CSC Badminton open 2020</h1>
            <p>จัดขึ้นในระหว่างวันที่ 22-23 กุมภาพันธ์ 2563
        ...
        <div class="col-md-6 col-lg-6 col-xl-3">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-3">
                        <img src="image/2.jpg" alt="" width="400" />
                    </div>
                    <div class="col-lg-3">
                        <img src="image/35.jpg" alt="" width="400" class="move-right" />
                    </div>
                    <div class="col-lg-3">
                        <img src="image/36.jpg" alt="" width="400" class="a-right" />
                    </div>
                </div>
            </div>
            <div class="container-fluid">
                <h1>ผลการแข่งขัน</h1>
                <p>ประเภท มือ P-</p>
                <p>ชนะเลิศ : พิมุข อินทรสูต , จามิกร สุนารักษ์ (SNRU)</p>
                <p>รองชนะเลิศอันดับ 1 : ณัฐพล ฐิติพิปุลยางกุล , จักรพรรดิ ผาบแก้ว (ไฮยีน่า)</p>
                <p>รองชนะเลิศอันดับ 2 : วีรชาติ อามาตรทอง , วีรวัฒน์ พัดไทสง (ไฮยีน่า) และ ภูสิริโชคค์ จตุรภัทร์ถิระโชติ , นล เตโช (ไฮยีน่า)</p>
