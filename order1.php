                    ...
                    <div class="service-item rounded">
                        ...
                        <div class="service-content rounded-bottom bg-light p-4">
                            <div class="service-content-inner">
                                ...
                                <a href="order2.php" class="btn btn-primary rounded-pill text-white py-2 px-4 mb-2">รายละเอียด</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="service-item rounded">
                        ...
                        <div class="service-content rounded-bottom bg-light p-4">
                            <div class="service-content-inner">
                                ...
                                <a href="order3.php" class="btn btn-primary rounded-pill text-white py-2 px-4 mb-2">รายละเอียด</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="service-item rounded">
                        ...
                        <div class="service-content rounded-bottom bg-light p-4">
                            <div class="service-content-inner">
                                ...
                                <a href="order4.php" class="btn btn-primary rounded-pill text-white py-2 px-4 mb-2">รายละเอียด</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="service-item rounded">
                        ...
                        <div class="service-content rounded-bottom bg-light p-4">
                            <div class="service-content-inner">
                                ...
                                <a href="order5.php" class="btn btn-primary rounded-pill text-white py-2 px-4 mb-2">รายละเอียด</a>
                            </div>
                        </div>
                    </div>
                </div>
