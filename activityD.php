...
<body>
    ...
    <div class="container-fluid position-relative p-0">
        ...
        <div class="container-fluid">
            <h1>นนทรีอีสานแบดมินตันคัพ ครั้งที่ 15</h1>
            <p>จัดขึ้นในวันที่ 2-3 ธันวาคม 2566
        ...
        <div class="col-md-6 col-lg-6 col-xl-3">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-3">
                        <img src="image/5.jpg" alt="" width="400" />
                    </div>

                    <div class="col-lg-3">
                        <img src="image/26.jpg" alt="" width="410" class="move-right" />
                    </div>
                    <div class="col-lg-3">
                        <img src="image/27.jpg" alt="" width="400" class="a-right" />
                    </div>
                    <div class="col-lg-3">
                        <img src="image/28.jpg" alt="" width="410" class="b-right" />
                    </div>
                </div>
                <div class="container-fluid">
                    <h1>ผลการแข่งขัน</h1>
                    <p>**ประเภทคู่มือ S/N**</p>
                    <p>ชนะเลิศ : มหาสมุทร, สุธินันท์ (นาคูพัฒนา)</p>
                    <p> รองชนะเลิศอันดับ 1 : สิรินดา, อดิเทพ (SNRU)</p>
                    <p> รองชนะเลิศอันดับ 2 :อนุพงศ์, สิทธิกร (โบ๊ะบ๊ะ)และ ณรงค์ธร, เพ็ญเพชร (แคทเทอรีนส์)</p>
                </div>
            </div>
        </div>
