        ...
        <main class="app-main"> <!--begin::App Content Header-->
            <div class="app-content">
                ...
                <div class="container-fluid">
                    ...
                    <h4>ลูกแบดมินตันพลาสติก</h4>
                    <img src="image/17.jpg" alt="image">
                    <p>
                        1.ลูกพลาสติกของ Yonex
                        ราคาลูกละ 60 บาท
                    </p>
                    <p>
                        **ถ้ามากับเพื่อนอีก 4 คนสามารถหารกันได้
                        ตกคนละ 15 บาท</p>
                    <p> เหลือจำนวนสินค้าอีก 10 ลูก</p>
                ...
                <div class="container-fluid">
                    ...
                    <h4></h4>
                    <img src="image/18.jpg" alt="image">
                    <p>
                        2.ลูกพลาสติกของ Victor
                        ราคาลูกละ 60 บาท
                    </p>
                    <p>
                        **ถ้ามากับเพื่อนอีก 4 คนสามารถหารกันได้
