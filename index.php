                        ...
                        <div class="service-item rounded">
                            ...
                            <div class="service-content rounded-bottom bg-light p-4">
                                <div class="service-content-inner">
                                    ...
                                    <a href="activityA.php" class="btn btn-primary rounded-pill text-white py-2 px-4 mb-2">รายละเอียด</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="service-item rounded">
                            ...
                            <div class="service-content rounded-bottom bg-light p-4">
                                <div class="service-content-inner">
                                    ...
                                    <a href="activityB.php" class="btn btn-primary rounded-pill text-white py-2 px-4 mb-2">รายละเอียด</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="service-item rounded">
                            ...
                            <div class="service-content rounded-bottom bg-light p-4">
                                <div class="service-content-inner">
                                    ...
                                    <a href="activityC.php" class="btn btn-primary rounded-pill text-white py-2 px-4 mb-2">รายละเอียด</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="service-item rounded">
                            ...
                            <div class="service-content rounded-bottom bg-light p-4">
                                <div class="service-content-inner">
                                    ...
                                    <a href="activityD.php" class="btn btn-primary rounded-pill text-white py-2 px-4 mb-2">รายละเอียด</a>
                                </div>
                            </div>
                        </div>
                    </div>
